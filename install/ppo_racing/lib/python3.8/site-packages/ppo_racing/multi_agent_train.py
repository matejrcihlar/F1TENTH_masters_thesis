...
def main():
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            trainer.remember('agent1', obs_ego, action_ego, prob_ego, val_ego, reward_ego, done)
            #trainer.remember('agent2', obs_opp, action_opp, prob_opp, val_opp, reward_opp, done)
        ...
        avg_score = avg_score_ego + avg_score_opp
...
def reset_poses(flat_waypoints):
    ...
    rand_dist = np.random.randint(2, 5)
    #rand_dist = 3
